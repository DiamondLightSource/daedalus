...
export default function Editor() {
  const [widgetProperties, setWidgetProperties] = useState<WidgetProps>({
    x: "",
    y: "",
    w: "",
    h: ""
  ...
  function handleClick(event: any) {
    ...
    setDisplaySelected(
      (target.className as string) === "display" ? true : false
    );
  ...
  function getWidgetCoords(widget: any) {
    ...
    if (
      widget.tagName === "DIV" &&
      (widget.className as string).includes("Widget")
    ) {
