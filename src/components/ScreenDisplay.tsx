...
import { Box, Paper as MuiPaper, PaperProps as MuiPaperProps, styled } from '@mui/material';
import { useHistory, useLocation } from 'react-router-dom';
import { DynamicPageWidget, FileContext, RelativePosition } from '@diamondlightsource/cs-web-lib';
